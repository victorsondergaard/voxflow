...
- **Make a Searchable PDF (OCR)** (menu): give VoxFlow a scanned PDF or a photo of a document and it saves a copy that looks pixel-identical but has an invisible text layer aligned over every word — so you can select, search, copy, and use any read-aloud tool on it. Pages that already have text pass through untouched.
